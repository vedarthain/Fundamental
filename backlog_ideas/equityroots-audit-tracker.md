...
| 3 | /stock/TITAN | [L] **Contradictory financials.** Revenue shown +80.5% YoY but +5.9% QoQ — implausible for Titan; likely standalone-vs-consolidated mixup or wrong comparison quarter. Same panel: net profit +35.4% YoY but −30% QoQ with narrative "Net profit is higher year-on-year" glossing the sequential collapse. | Q4 FY26 panel on TITAN page | Audit the YoY base-period logic; enforce standalone/consolidated consistency; add sanity bounds (flag YoY > 50% for large caps for manual review) | ☑ NOT a data bug — verified all four figures correct & internally consistent against app.fundamentals_quarterly (Q4 FY26 26920/1179 vs Q4 FY25 14916/871 = +80.5%/+35.4%; QoQ vs 25416/1684 = +5.9%/−30.0%). The +80.5% is real, flattered by a soft year-ago base. Fixed presentationally: interpretQuarter now surfaces a material (≤−15%) sequential drop in the headline; the NP progress line states YoY and QoQ with equal billing when they diverge instead of leading "higher year-on-year". |
...
| 20 | /stock/TITAN | [C] Narrative text contradicts its own bullets: headline says "profitability slipped" while bullets lead with positives (+80% rev, +35% NP) — the −30% QoQ profit fall is buried mid-bullet. | Progress panel | Rework the template so sequential deterioration leads when it's the dominant signal | ☑ Fixed with #3: headline appends the sequential drop; NP bullet no longer leads "higher year-on-year" when YoY/QoQ diverge. Note: surfaced neutrally (a QoQ swing is often seasonal, e.g. jewellery Q3 vs Q4) rather than asserting deterioration. |
...
| 36 | /stock/TITAN | P0 | [C] Reconfirmed in live browser: +80.5% YoY revenue vs +5.9% QoQ — user-facing, not a cache artifact. #3 stands at full severity | Same as #3 | ☑ Resolved with #3/#20 — figures verified correct (real, not a bug); fixed the misleading YoY-only framing, not the numbers. |
